...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Clovece, nehnevaj sa!", 1400, 750, 
                                         FarbyRGB.getFarba("slaboHneda"));
        }
    ...
    public void setForegroundColor(String farba) {
        ...
        } else if (farba.equals("slaboModra")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboModra"));
        } else if (farba.equals("slaboZelena")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboZelena"));
        } else if (farba.equals("slaboZlta")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboZlta"));
        } else if (farba.equals("slaboCervena")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboCervena"));
        } else if (farba.equals("slaboHneda")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboHneda"));
        } else if (farba.equals("seda")) {
            this.graphic.setColor(FarbyRGB.getFarba("seda"));
        } else if (farba.equals("slaboSeda")) {
            this.graphic.setColor(FarbyRGB.getFarba("slaboSeda"));
        } else {
            this.graphic.setColor(Color.black);
        }
